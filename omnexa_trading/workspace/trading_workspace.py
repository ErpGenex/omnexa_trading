...
WORKSPACE_SECTIONS: list[tuple[str, list[WorkspaceLink]]] = [
	(
		...
		[
			("Page", "trading-workcenter", "Commerce Workcenter"),
	...
	(
		"💊 Pharmaceutical Compliance (GDP/GMP)",
		[
			("DocType", "Pharma Batch", "Pharma Batch"),
			("DocType", "Pharma Drug Registration", "Drug Registration"),
			("DocType", "Pharma Quality Inspection", "Quality Inspection"),
			("DocType", "Pharma Product Recall", "Product Recall"),
			("DocType", "Pharma Regulatory Approval", "Regulatory Approval"),
			("DocType", "Pharma Drug License", "Drug License"),
			("DocType", "Pharma Import License", "Import License"),
			("DocType", "Pharma Export Shipment", "Export Shipment"),
			("DocType", "Pharma Sample Register", "Sample Register"),
			("DocType", "Pharma Import LC", "Import LC"),
			("DocType", "Temperature Log", "Temperature Log"),
			("DocType", "Temperature Excursion", "Temperature Excursion"),
		],
	),
	(
		...
		[
			("DocType", "CAPA", "CAPA"),
			("DocType", "Deviation", "Deviation"),
			("DocType", "SOP Management", "SOP Management"),
			("DocType", "Training Record", "Training Record"),
			("DocType", "Electronic Signature", "Electronic Signature"),
			("DocType", "Validation Protocol", "Validation Protocol"),
			("DocType", "Risk Assessment", "Risk Assessment"),
			("DocType", "Vendor Qualification", "Vendor Qualification"),
			("DocType", "Equipment Qualification", "Equipment Qualification"),
		],
	),
	(
		"🌐 Pharma Role Portals",
		[
			("Page", "trading-ceo", "CEO Portal"),
			("Page", "trading-chairman", "Chairman Portal"),
			("Page", "trading-general-manager", "General Manager"),
			("Page", "trading-commercial-director", "Commercial Director"),
			("Page", "trading-operations-director", "Operations Director"),
			("Page", "trading-finance-director", "Finance Director"),
			("Page", "trading-hr-director", "HR Director"),
			("Page", "trading-quality-manager", "Quality Manager"),
			("Page", "trading-import-manager", "Import Manager"),
			("Page", "trading-export-manager", "Export Manager"),
			("Page", "trading-warehouse-manager", "Warehouse Manager"),
			("Page", "trading-cold-chain-manager", "Cold Chain Manager"),
			("Page", "trading-regulatory-officer", "Regulatory Officer"),
			("Page", "trading-sales-director", "Sales Director"),
			("Page", "trading-area-manager", "Area Manager"),
			("Page", "trading-sales-supervisor", "Sales Supervisor"),
			("Page", "trading-van-sales-pwa", "Medical Representative"),
			("Page", "trading-customer-service", "Customer Service"),
			("Page", "trading-treasury", "Treasury"),
			("Page", "trading-finance-desk", "Chief Accountant"),
			("Page", "trading-cashier", "Cashier"),
			("Page", "trading-inventory-controller", "Inventory Controller"),
			("Page", "trading-store-keeper", "Store Keeper"),
			("Page", "trading-dispatch", "Dispatch"),
			("Page", "trading-receiving", "Receiving"),
			("Page", "trading-auditor", "Auditor"),
			("Page", "trading-workcenter", "System Administrator"),
		],
	),
	(
		"📈 Reports · Finance & POS",
...
def _build_content(link_rows: list[dict], ws) -> str:
	...
	for row in link_rows:
		if row.get("type") == "Card Break":
			if section_idx:
				content.append({"id": f"trading-sp-{section_idx
